...
namespace ex_8.EntityClasses
{
	...
	
	{
		...
		protected class CategoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("CategoryEntity", InheritanceHierarchyType.None, false, (int)ex_8.EntityType.CategoryEntity, typeof(CategoryEntity), typeof(CategoryEntityFactory), false);
			}
		}
		...
		/// <remarks>Mapped on  table field: "Category"."name".<br/>Table field type characteristics (type, precision, scale, length): Text, 0, 0, 1073741824.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
